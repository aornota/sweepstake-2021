...
type ServerAppWsApi =
    ...
    | SignOutResultWs of result : Result<SessionId, string> // TODO-NMB: If no need for SessionId, use unit?...
    | AutoSignOutWs of sessionId : SessionId // TODO-NMB: If no need for SessionId, use unit - or, e.g., AutoSignOutReason?...
    | OtherUserSignedIn of userName : string // TODO-NMB: Should this be a ServerChatWs case, e.g. as a ChatUsers "projection"?...
    | OtherUserSignedOut of userName : string // TODO-NMB: Should this be a ServerChatWs case, e.g. as a ChatUsers "projection"?...
